    ...
    describe('Methods', function() {
        ...
        describe('extend', function() {
            it('Extend an object with another object should return a merge of both', function() {
                _.extend({}, { foo: 'bar' }, { bar: 'foo' }).should.be.deep.equal({ foo: 'bar',
                    bar: 'foo' });
            });
        });
        ...
        describe('sortBy', function() {
            ...
            it('Should return the array ordered by property name', function() {
                let stooges = [{ name: 'moe', age: 40 }, { name: 'larry', age: 50 }, { name: 'curly',
                        age: 60 }],
                    ret = _.sortBy(stooges, 'name');
                ret.should.be.deep.equal([{ name: 'curly', age: 60 }, { name: 'larry',
                    age: 50 }, { name: 'moe', age: 40 }]);
            });
